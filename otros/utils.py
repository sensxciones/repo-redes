...
# toma una mensaje HTTP y lo transfiere a una estructura de datos que permite acceder facilmente la informacion del mensaje
def parse_HTTP_message(http_message):
    ...
    if body:
        http_message_dict["body"] = body.strip()
    return http_message_dict
    

# toma una estructura de datos retornada por parse_http_message y la transforma en un mensaje HTTP
...
# elimina la secuencia de fin de mensaje del mensaje completo
