...
if __name__ == "__main__":
    ...
    # LOSS_PROBABILITY = 10
    # El cliente debe leer un archivo cuya ubicación o ruta se recibe desde
    # entrada estándar (usando la función input de python)
    # ruta = input("Ingresa la ruta: ")
    # ej. redes/trabajo-controles/texto.txt
    # Luego, el cliente debe enviar los contenidos de este archivo al receptor en trozos de a lo más 16 bytes.
    # with open(ruta, "r") as file:
    #    msg = file.read()
    #    msg_array = []
    #    for i in range(0, len(msg), BYTES_SIZE):
    #        msg_array.append(msg[i : i + BYTES_SIZE].encode())
