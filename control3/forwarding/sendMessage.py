...
if __name__ == "__main__":
    # formato de entrega:
    # python sendMessage.py [IP_router_final] [puerto_router_final] [mensaje] [IP_envío] [puerto_envío]:
    if len(sys.argv) < 6:
        raise Exception(
            "Formato: python sendMessage.py [IP_router_final] [puerto_router_final] [mensaje] [IP_envío] [puerto_envío]"
        )
